...
> 🕐 **Updated:** 2026-09-14 08:45 UTC &nbsp;|&nbsp; **Commit:** [`f40e6fd`](https://github.com/punitmishra/pi-race/actions/runs/34824308063) &nbsp;|&nbsp; **Winner:** **Ramanujan** with `15` correct digits &nbsp;|&nbsp; **Tier:** `extreme`
...
|------------|--------|--------|--------|--------|
| `10` | `13.5µs` | `0.1µs` | `0.3µs` | `0.3µs` |
| `100` | `23.4µs` | `0.2µs` | `0.2µs` | `0.2µs` |
| `1K` | `20.5µs` | `1.6µs` | `1.8µs` | `1.7µs` |
| `10K` | `20.1µs` | `17.4µs` | `15.9µs` | `17.2µs` |
| `100K` | `19.8µs` | `168.2µs` | `158.3µs` | `169.8µs` |
| `1M` | `19.6µs` | `1.72ms` | `1.60ms` | `1.68ms` |
| `5M` | `19.6µs` | `8.80ms` | `8.06ms` | `8.16ms` |
| `10M` | `19.6µs` | `17.27ms` | `16.44ms` | `16.76ms` |
| `50M` | `19.6µs` | `86.84ms` | `87.51ms` | `82.15ms` |
...
| 🥈 | **Leibniz** ■ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592633590251` | `2.00e-8` | `82.15ms` |
| 🥉 | **Euler/Basel** ▲ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592634444062` | `1.91e-8` | `86.84ms` |
| 4th | **Wallis** ● | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592643066262` | `1.05e-8` | `87.51ms` |
