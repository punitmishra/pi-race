...
> 🕐 **Updated:** 2026-09-07 08:07 UTC &nbsp;|&nbsp; **Commit:** [`a0d88db`](https://github.com/punitmishra/pi-race/actions/runs/34098921856) &nbsp;|&nbsp; **Winner:** **Ramanujan** with `15` correct digits &nbsp;|&nbsp; **Tier:** `extreme`
...
|------------|--------|--------|--------|--------|
| `10` | `13.4µs` | `0.1µs` | `0.7µs` | `0.4µs` |
| `100` | `24.8µs` | `0.3µs` | `0.3µs` | `0.2µs` |
| `1K` | `23.9µs` | `1.9µs` | `2.1µs` | `1.9µs` |
| `10K` | `23.4µs` | `18.4µs` | `18.6µs` | `18.5µs` |
| `100K` | `23.0µs` | `200.8µs` | `196.4µs` | `212.4µs` |
| `1M` | `22.8µs` | `2.08ms` | `2.00ms` | `1.87ms` |
| `5M` | `22.8µs` | `10.18ms` | `9.69ms` | `9.70ms` |
| `10M` | `22.8µs` | `20.30ms` | `19.60ms` | `19.22ms` |
| `50M` | `22.8µs` | `101.14ms` | `100.99ms` | `95.88ms` |

### Accuracy Race @ `50M`

| Rank | Algorithm | Digits | Accuracy | Estimate | Error | Time |
|------|-----------|--------|----------|----------|-------|------|
| 🥇 | **Ramanujan** ◆ | `15` | `████████████████████ 100%` | `3.141592653589793` | `0.00e0` | `22.8µs` |
| 🥈 | **Leibniz** ■ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592633590251` | `2.00e-8` | `95.88ms` |
| 🥉 | **Wallis** ● | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592643066262` | `1.05e-8` | `100.99ms` |
| 4th | **Euler/Basel** ▲ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592634444062` | `1.91e-8` | `101.14ms` |
