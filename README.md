...
> 🕐 **Updated:** 2026-05-18 07:01 UTC &nbsp;|&nbsp; **Commit:** [`569ca44`](https://github.com/punitmishra/pi-race/actions/runs/26018541694) &nbsp;|&nbsp; **Winner:** **Ramanujan** with `15` correct digits &nbsp;|&nbsp; **Tier:** `extreme`
...
|------------|--------|--------|--------|--------|
| `10` | `12.5µs` | `0.1µs` | `0.3µs` | `0.2µs` |
| `100` | `23.4µs` | `0.2µs` | `0.2µs` | `0.2µs` |
| `1K` | `20.3µs` | `1.6µs` | `1.7µs` | `1.6µs` |
| `10K` | `19.9µs` | `15.8µs` | `15.9µs` | `16.0µs` |
| `100K` | `19.6µs` | `170.5µs` | `159.2µs` | `172.7µs` |
| `1M` | `19.4µs` | `1.77ms` | `1.61ms` | `1.61ms` |
| `5M` | `19.5µs` | `8.78ms` | `8.03ms` | `8.18ms` |
| `10M` | `19.4µs` | `17.39ms` | `16.07ms` | `16.70ms` |
| `50M` | `19.4µs` | `85.74ms` | `80.39ms` | `82.12ms` |

### Accuracy Race @ `50M`

| Rank | Algorithm | Digits | Accuracy | Estimate | Error | Time |
|------|-----------|--------|----------|----------|-------|------|
| 🥇 | **Ramanujan** ◆ | `15` | `████████████████████ 100%` | `3.141592653589793` | `0.00e0` | `19.4µs` |
| 🥈 | **Wallis** ● | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592643066262` | `1.05e-8` | `80.39ms` |
| 🥉 | **Leibniz** ■ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592633590251` | `2.00e-8` | `82.12ms` |
| 4th | **Euler/Basel** ▲ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592634444062` | `1.91e-8` | `85.74ms` |
