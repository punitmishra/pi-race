...
> 🕐 **Updated:** 2026-04-13 04:12 UTC &nbsp;|&nbsp; **Commit:** [`823c6d6`](https://github.com/punitmishra/pi-race/actions/runs/24325298796) &nbsp;|&nbsp; **Winner:** **Ramanujan** with `15` correct digits &nbsp;|&nbsp; **Tier:** `extreme`
...
|------------|--------|--------|--------|--------|
| `10` | `14.0µs` | `0.1µs` | `0.1µs` | `0.1µs` |
| `100` | `21.2µs` | `0.2µs` | `0.2µs` | `0.2µs` |
| `1K` | `20.2µs` | `1.4µs` | `1.4µs` | `1.5µs` |
| `10K` | `20.4µs` | `14.0µs` | `14.0µs` | `13.9µs` |
| `100K` | `19.9µs` | `138.9µs` | `142.6µs` | `138.9µs` |
| `1M` | `19.9µs` | `1.42ms` | `1.41ms` | `1.40ms` |
| `5M` | `19.9µs` | `7.09ms` | `7.02ms` | `7.04ms` |
| `10M` | `19.8µs` | `14.08ms` | `14.02ms` | `14.09ms` |
| `50M` | `19.9µs` | `70.23ms` | `70.28ms` | `70.44ms` |

### Accuracy Race @ `50M`

| Rank | Algorithm | Digits | Accuracy | Estimate | Error | Time |
|------|-----------|--------|----------|----------|-------|------|
| 🥇 | **Ramanujan** ◆ | `15` | `████████████████████ 100%` | `3.141592653589793` | `0.00e0` | `19.9µs` |
| 🥈 | **Euler/Basel** ▲ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592634444062` | `1.91e-8` | `70.23ms` |
| 🥉 | **Wallis** ● | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592643066262` | `1.05e-8` | `70.28ms` |
| 4th | **Leibniz** ■ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592633590251` | `2.00e-8` | `70.44ms` |
