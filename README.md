...
> 🕐 **Updated:** 2026-06-15 04:39 UTC &nbsp;|&nbsp; **Commit:** [`5f6d2f3`](https://github.com/punitmishra/pi-race/actions/runs/27524405099) &nbsp;|&nbsp; **Winner:** **Ramanujan** with `15` correct digits &nbsp;|&nbsp; **Tier:** `extreme`
...
|------------|--------|--------|--------|--------|
| `10` | `9.3µs` | `0.1µs` | `0.3µs` | `0.2µs` |
| `100` | `21.3µs` | `0.2µs` | `0.2µs` | `0.2µs` |
| `1K` | `20.3µs` | `1.4µs` | `1.5µs` | `1.5µs` |
| `10K` | `20.4µs` | `13.9µs` | `13.9µs` | `14.0µs` |
| `100K` | `20.0µs` | `139.0µs` | `144.7µs` | `138.9µs` |
| `1M` | `19.9µs` | `1.42ms` | `1.42ms` | `1.41ms` |
| `5M` | `19.9µs` | `7.13ms` | `7.01ms` | `7.03ms` |
| `10M` | `19.8µs` | `14.07ms` | `14.24ms` | `14.02ms` |
| `50M` | `19.8µs` | `70.11ms` | `70.64ms` | `70.31ms` |
...
| 🥈 | **Euler/Basel** ▲ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592634444062` | `1.91e-8` | `70.11ms` |
| 🥉 | **Leibniz** ■ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592633590251` | `2.00e-8` | `70.31ms` |
| 4th | **Wallis** ● | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592643066262` | `1.05e-8` | `70.64ms` |
