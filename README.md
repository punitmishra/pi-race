...
> 🕐 **Updated:** 2026-07-27 06:35 UTC &nbsp;|&nbsp; **Commit:** [`e3aa1b5`](https://github.com/punitmishra/pi-race/actions/runs/30243221623) &nbsp;|&nbsp; **Winner:** **Ramanujan** with `15` correct digits &nbsp;|&nbsp; **Tier:** `extreme`
...
|------------|--------|--------|--------|--------|
| `10` | `10.4µs` | `0.1µs` | `0.1µs` | `0.3µs` |
| `100` | `23.6µs` | `0.2µs` | `0.2µs` | `0.2µs` |
| `1K` | `20.4µs` | `1.4µs` | `1.5µs` | `1.5µs` |
| `10K` | `20.6µs` | `14.0µs` | `13.9µs` | `13.9µs` |
| `100K` | `20.0µs` | `138.9µs` | `139.0µs` | `147.5µs` |
| `1M` | `20.0µs` | `1.44ms` | `1.40ms` | `1.40ms` |
| `5M` | `20.1µs` | `7.05ms` | `7.01ms` | `8.00ms` |
| `10M` | `20.0µs` | `14.03ms` | `14.01ms` | `16.03ms` |
| `50M` | `20.0µs` | `70.18ms` | `87.01ms` | `70.32ms` |
...
| 🥈 | **Euler/Basel** ▲ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592634444062` | `1.91e-8` | `70.18ms` |
| 🥉 | **Leibniz** ■ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592633590251` | `2.00e-8` | `70.32ms` |
| 4th | **Wallis** ● | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592643066262` | `1.05e-8` | `87.01ms` |
