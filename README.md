...
> 🕐 **Updated:** 2026-05-04 04:24 UTC &nbsp;|&nbsp; **Commit:** [`aae5106`](https://github.com/punitmishra/pi-race/actions/runs/25300950221) &nbsp;|&nbsp; **Winner:** **Ramanujan** with `15` correct digits &nbsp;|&nbsp; **Tier:** `extreme`
...
|------------|--------|--------|--------|--------|
| `10` | `9.2µs` | `0.1µs` | `0.1µs` | `0.1µs` |
| `100` | `21.0µs` | `0.2µs` | `0.2µs` | `0.2µs` |
| `1K` | `20.5µs` | `1.4µs` | `1.5µs` | `1.5µs` |
| `10K` | `20.6µs` | `13.9µs` | `14.0µs` | `14.0µs` |
| `100K` | `20.1µs` | `139.0µs` | `149.1µs` | `139.0µs` |
| `1M` | `20.0µs` | `1.44ms` | `1.41ms` | `1.41ms` |
| `5M` | `20.1µs` | `7.06ms` | `7.01ms` | `7.04ms` |
| `10M` | `20.1µs` | `14.10ms` | `14.01ms` | `14.08ms` |
| `50M` | `20.0µs` | `70.45ms` | `70.32ms` | `70.46ms` |
...
| 🥈 | **Wallis** ● | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592643066262` | `1.05e-8` | `70.32ms` |
| 🥉 | **Euler/Basel** ▲ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592634444062` | `1.91e-8` | `70.45ms` |
| 4th | **Leibniz** ■ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592633590251` | `2.00e-8` | `70.46ms` |
