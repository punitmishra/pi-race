...
> 🕐 **Updated:** 2026-06-29 04:38 UTC &nbsp;|&nbsp; **Commit:** [`abfd257`](https://github.com/punitmishra/pi-race/actions/runs/28348981301) &nbsp;|&nbsp; **Winner:** **Ramanujan** with `15` correct digits &nbsp;|&nbsp; **Tier:** `extreme`
...
|------------|--------|--------|--------|--------|
| `10` | `15.0µs` | `0.1µs` | `0.1µs` | `0.1µs` |
| `100` | `22.7µs` | `0.2µs` | `0.2µs` | `0.2µs` |
| `1K` | `20.4µs` | `1.4µs` | `1.5µs` | `1.5µs` |
| `10K` | `20.3µs` | `13.9µs` | `14.5µs` | `13.9µs` |
| `100K` | `19.8µs` | `167.0µs` | `151.3µs` | `139.1µs` |
| `1M` | `19.9µs` | `1.41ms` | `1.43ms` | `1.42ms` |
| `5M` | `19.8µs` | `7.09ms` | `7.02ms` | `7.00ms` |
| `10M` | `19.8µs` | `14.17ms` | `14.03ms` | `14.00ms` |
| `50M` | `19.9µs` | `70.10ms` | `70.33ms` | `70.06ms` |
...
| 🥈 | **Leibniz** ■ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592633590251` | `2.00e-8` | `70.06ms` |
| 🥉 | **Euler/Basel** ▲ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592634444062` | `1.91e-8` | `70.10ms` |
| 4th | **Wallis** ● | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592643066262` | `1.05e-8` | `70.33ms` |
