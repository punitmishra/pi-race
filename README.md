...
> 🕐 **Updated:** 2026-09-21 08:47 UTC &nbsp;|&nbsp; **Commit:** [`5a9cf82`](https://github.com/punitmishra/pi-race/actions/runs/35579672483) &nbsp;|&nbsp; **Winner:** **Ramanujan** with `15` correct digits &nbsp;|&nbsp; **Tier:** `extreme`
...
|------------|--------|--------|--------|--------|
| `10` | `10.2µs` | `0.1µs` | `0.1µs` | `0.1µs` |
| `100` | `22.4µs` | `0.2µs` | `0.2µs` | `0.2µs` |
| `1K` | `20.4µs` | `1.5µs` | `1.5µs` | `1.5µs` |
| `10K` | `20.4µs` | `13.9µs` | `14.0µs` | `14.0µs` |
| `100K` | `20.1µs` | `165.3µs` | `138.9µs` | `138.9µs` |
| `1M` | `20.0µs` | `1.41ms` | `1.40ms` | `1.40ms` |
| `5M` | `20.0µs` | `7.07ms` | `7.00ms` | `7.00ms` |
| `10M` | `20.0µs` | `14.06ms` | `14.02ms` | `14.04ms` |
| `50M` | `19.9µs` | `70.65ms` | `71.51ms` | `70.24ms` |
...
| 🥈 | **Leibniz** ■ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592633590251` | `2.00e-8` | `70.24ms` |
| 🥉 | **Euler/Basel** ▲ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592634444062` | `1.91e-8` | `70.65ms` |
| 4th | **Wallis** ● | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592643066262` | `1.05e-8` | `71.51ms` |
