...
> 🕐 **Updated:** 2026-04-06 04:06 UTC &nbsp;|&nbsp; **Commit:** [`0c9a03f`](https://github.com/punitmishra/pi-race/actions/runs/24018211244) &nbsp;|&nbsp; **Winner:** **Ramanujan** with `15` correct digits &nbsp;|&nbsp; **Tier:** `extreme`
...
|------------|--------|--------|--------|--------|
| `10` | `9.4µs` | `0.1µs` | `0.2µs` | `0.1µs` |
| `100` | `21.4µs` | `0.2µs` | `0.2µs` | `0.2µs` |
| `1K` | `20.3µs` | `1.4µs` | `1.5µs` | `1.4µs` |
| `10K` | `20.4µs` | `14.0µs` | `13.9µs` | `13.9µs` |
| `100K` | `19.8µs` | `138.9µs` | `138.9µs` | `139.1µs` |
| `1M` | `19.8µs` | `1.43ms` | `1.41ms` | `1.43ms` |
| `5M` | `19.9µs` | `7.09ms` | `7.01ms` | `7.04ms` |
| `10M` | `19.8µs` | `14.10ms` | `14.00ms` | `14.09ms` |
| `50M` | `19.8µs` | `70.17ms` | `70.34ms` | `70.71ms` |
...
| 🥈 | **Euler/Basel** ▲ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592634444062` | `1.91e-8` | `70.17ms` |
| 🥉 | **Wallis** ● | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592643066262` | `1.05e-8` | `70.34ms` |
| 4th | **Leibniz** ■ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592633590251` | `2.00e-8` | `70.71ms` |
