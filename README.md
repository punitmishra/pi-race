...
> 🕐 **Updated:** 2026-08-24 03:58 UTC &nbsp;|&nbsp; **Commit:** [`baacf7e`](https://github.com/punitmishra/pi-race/actions/runs/32688296227) &nbsp;|&nbsp; **Winner:** **Ramanujan** with `15` correct digits &nbsp;|&nbsp; **Tier:** `extreme`
...
|------------|--------|--------|--------|--------|
| `10` | `10.1µs` | `0.1µs` | `0.1µs` | `0.2µs` |
| `100` | `21.7µs` | `0.2µs` | `0.2µs` | `0.2µs` |
| `1K` | `47.3µs` | `1.6µs` | `1.7µs` | `1.6µs` |
| `10K` | `20.1µs` | `17.4µs` | `17.5µs` | `16.0µs` |
| `100K` | `19.7µs` | `172.2µs` | `160.7µs` | `168.7µs` |
| `1M` | `19.6µs` | `1.72ms` | `1.60ms` | `1.65ms` |
| `5M` | `19.6µs` | `8.56ms` | `8.05ms` | `8.14ms` |
| `10M` | `19.6µs` | `17.31ms` | `16.02ms` | `16.73ms` |
| `50M` | `19.6µs` | `86.53ms` | `80.59ms` | `81.90ms` |

### Accuracy Race @ `50M`

| Rank | Algorithm | Digits | Accuracy | Estimate | Error | Time |
|------|-----------|--------|----------|----------|-------|------|
| 🥇 | **Ramanujan** ◆ | `15` | `████████████████████ 100%` | `3.141592653589793` | `0.00e0` | `19.6µs` |
| 🥈 | **Wallis** ● | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592643066262` | `1.05e-8` | `80.59ms` |
| 🥉 | **Leibniz** ■ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592633590251` | `2.00e-8` | `81.90ms` |
| 4th | **Euler/Basel** ▲ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592634444062` | `1.91e-8` | `86.53ms` |
