...
> 🕐 **Updated:** 2026-07-06 04:33 UTC &nbsp;|&nbsp; **Commit:** [`49f1efb`](https://github.com/punitmishra/pi-race/actions/runs/28768007447) &nbsp;|&nbsp; **Winner:** **Ramanujan** with `15` correct digits &nbsp;|&nbsp; **Tier:** `extreme`
...
|------------|--------|--------|--------|--------|
| `10` | `10.2µs` | `0.1µs` | `0.3µs` | `0.5µs` |
| `100` | `21.8µs` | `0.2µs` | `0.2µs` | `0.2µs` |
| `1K` | `20.4µs` | `1.7µs` | `1.7µs` | `1.8µs` |
| `10K` | `19.9µs` | `16.9µs` | `16.0µs` | `15.7µs` |
| `100K` | `19.7µs` | `172.8µs` | `170.4µs` | `159.0µs` |
| `1M` | `19.5µs` | `1.75ms` | `1.65ms` | `1.73ms` |
| `5M` | `19.5µs` | `8.78ms` | `8.48ms` | `8.69ms` |
| `10M` | `19.5µs` | `17.51ms` | `16.93ms` | `17.42ms` |
| `50M` | `19.5µs` | `87.08ms` | `84.30ms` | `86.80ms` |

### Accuracy Race @ `50M`

| Rank | Algorithm | Digits | Accuracy | Estimate | Error | Time |
|------|-----------|--------|----------|----------|-------|------|
| 🥇 | **Ramanujan** ◆ | `15` | `████████████████████ 100%` | `3.141592653589793` | `0.00e0` | `19.5µs` |
| 🥈 | **Wallis** ● | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592643066262` | `1.05e-8` | `84.30ms` |
| 🥉 | **Leibniz** ■ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592633590251` | `2.00e-8` | `86.80ms` |
| 4th | **Euler/Basel** ▲ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592634444062` | `1.91e-8` | `87.08ms` |
