...
> 🕐 **Updated:** 2026-06-01 08:40 UTC &nbsp;|&nbsp; **Commit:** [`b114b17`](https://github.com/punitmishra/pi-race/actions/runs/26744351248) &nbsp;|&nbsp; **Winner:** **Ramanujan** with `15` correct digits &nbsp;|&nbsp; **Tier:** `extreme`
...
|------------|--------|--------|--------|--------|
| `10` | `10.3µs` | `0.1µs` | `0.1µs` | `0.1µs` |
| `100` | `20.9µs` | `0.2µs` | `0.2µs` | `0.2µs` |
| `1K` | `20.3µs` | `1.5µs` | `1.5µs` | `1.5µs` |
| `10K` | `20.2µs` | `13.9µs` | `14.5µs` | `14.0µs` |
| `100K` | `51.6µs` | `138.9µs` | `144.0µs` | `139.0µs` |
| `1M` | `20.2µs` | `1.41ms` | `1.43ms` | `1.41ms` |
| `5M` | `20.0µs` | `7.12ms` | `7.02ms` | `8.43ms` |
| `10M` | `20.0µs` | `14.09ms` | `14.09ms` | `17.00ms` |
| `50M` | `20.0µs` | `70.12ms` | `70.65ms` | `71.14ms` |
...
| 🥈 | **Euler/Basel** ▲ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592634444062` | `1.91e-8` | `70.12ms` |
| 🥉 | **Wallis** ● | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592643066262` | `1.05e-8` | `70.65ms` |
| 4th | **Leibniz** ■ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592633590251` | `2.00e-8` | `71.14ms` |
