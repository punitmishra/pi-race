...
> 🕐 **Updated:** 2026-08-31 09:33 UTC &nbsp;|&nbsp; **Commit:** [`db29e93`](https://github.com/punitmishra/pi-race/actions/runs/33378266251) &nbsp;|&nbsp; **Winner:** **Ramanujan** with `15` correct digits &nbsp;|&nbsp; **Tier:** `extreme`
...
|------------|--------|--------|--------|--------|
| `10` | `11.1µs` | `0.1µs` | `0.2µs` | `0.3µs` |
| `100` | `21.8µs` | `0.2µs` | `0.2µs` | `0.2µs` |
| `1K` | `19.3µs` | `1.4µs` | `1.5µs` | `1.5µs` |
| `10K` | `19.2µs` | `51.0µs` | `14.4µs` | `14.6µs` |
| `100K` | `19.0µs` | `133.6µs` | `143.9µs` | `145.3µs` |
| `1M` | `18.9µs` | `1.35ms` | `1.45ms` | `1.47ms` |
| `5M` | `18.9µs` | `6.78ms` | `7.23ms` | `7.35ms` |
| `10M` | `18.9µs` | `13.51ms` | `14.86ms` | `14.72ms` |
| `50M` | `18.9µs` | `66.97ms` | `73.15ms` | `74.01ms` |

### Accuracy Race @ `50M`

| Rank | Algorithm | Digits | Accuracy | Estimate | Error | Time |
|------|-----------|--------|----------|----------|-------|------|
| 🥇 | **Ramanujan** ◆ | `15` | `████████████████████ 100%` | `3.141592653589793` | `0.00e0` | `18.9µs` |
| 🥈 | **Euler/Basel** ▲ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592634444062` | `1.91e-8` | `66.97ms` |
| 🥉 | **Wallis** ● | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592643066262` | `1.05e-8` | `73.15ms` |
| 4th | **Leibniz** ■ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592633590251` | `2.00e-8` | `74.01ms` |
