...
> 🕐 **Updated:** 2026-07-13 06:25 UTC &nbsp;|&nbsp; **Commit:** [`69f4c8b`](https://github.com/punitmishra/pi-race/actions/runs/29228920787) &nbsp;|&nbsp; **Winner:** **Ramanujan** with `15` correct digits &nbsp;|&nbsp; **Tier:** `extreme`
...
|------------|--------|--------|--------|--------|
| `10` | `9.4µs` | `0.1µs` | `0.1µs` | `0.1µs` |
| `100` | `21.1µs` | `0.2µs` | `0.2µs` | `0.2µs` |
| `1K` | `20.2µs` | `1.4µs` | `1.5µs` | `1.4µs` |
| `10K` | `20.2µs` | `13.9µs` | `13.9µs` | `13.9µs` |
| `100K` | `20.1µs` | `157.5µs` | `138.9µs` | `139.0µs` |
| `1M` | `19.9µs` | `1.40ms` | `1.41ms` | `1.41ms` |
| `5M` | `19.8µs` | `7.04ms` | `7.01ms` | `7.04ms` |
| `10M` | `19.9µs` | `14.23ms` | `14.02ms` | `14.10ms` |
| `50M` | `19.9µs` | `70.11ms` | `70.35ms` | `70.33ms` |
...
| 🥉 | **Leibniz** ■ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592633590251` | `2.00e-8` | `70.33ms` |
| 4th | **Wallis** ● | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592643066262` | `1.05e-8` | `70.35ms` |
