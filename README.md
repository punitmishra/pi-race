...
> 🕐 **Updated:** 2026-05-11 04:32 UTC &nbsp;|&nbsp; **Commit:** [`54406c7`](https://github.com/punitmishra/pi-race/actions/runs/25650408663) &nbsp;|&nbsp; **Winner:** **Ramanujan** with `15` correct digits &nbsp;|&nbsp; **Tier:** `extreme`
...
|------------|--------|--------|--------|--------|
| `10` | `9.1µs` | `0.1µs` | `0.1µs` | `0.1µs` |
| `100` | `21.5µs` | `0.2µs` | `0.2µs` | `0.2µs` |
| `1K` | `20.4µs` | `1.5µs` | `1.5µs` | `1.4µs` |
| `10K` | `20.5µs` | `14.0µs` | `14.0µs` | `13.9µs` |
| `100K` | `20.0µs` | `138.9µs` | `140.2µs` | `139.0µs` |
| `1M` | `46.0µs` | `1.41ms` | `1.41ms` | `1.40ms` |
| `5M` | `20.0µs` | `7.10ms` | `7.05ms` | `7.02ms` |
| `10M` | `19.9µs` | `14.11ms` | `14.01ms` | `14.02ms` |
| `50M` | `19.8µs` | `70.50ms` | `70.30ms` | `70.14ms` |
...
| 🥈 | **Leibniz** ■ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592633590251` | `2.00e-8` | `70.14ms` |
| 🥉 | **Wallis** ● | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592643066262` | `1.05e-8` | `70.30ms` |
| 4th | **Euler/Basel** ▲ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592634444062` | `1.91e-8` | `70.50ms` |
