...
> 🕐 **Updated:** 2026-08-17 03:54 UTC &nbsp;|&nbsp; **Commit:** [`0858c35`](https://github.com/punitmishra/pi-race/actions/runs/31992638013) &nbsp;|&nbsp; **Winner:** **Ramanujan** with `15` correct digits &nbsp;|&nbsp; **Tier:** `extreme`
...
|------------|--------|--------|--------|--------|
| `10` | `9.7µs` | `0.1µs` | `0.4µs` | `0.3µs` |
| `100` | `21.4µs` | `0.2µs` | `0.2µs` | `0.2µs` |
| `1K` | `20.4µs` | `1.4µs` | `1.5µs` | `1.7µs` |
| `10K` | `50.7µs` | `13.9µs` | `14.0µs` | `16.6µs` |
| `100K` | `32.1µs` | `138.9µs` | `138.9µs` | `163.8µs` |
| `1M` | `19.9µs` | `1.40ms` | `1.40ms` | `1.72ms` |
| `5M` | `19.9µs` | `7.03ms` | `7.01ms` | `8.56ms` |
| `10M` | `19.9µs` | `14.11ms` | `14.06ms` | `14.23ms` |
| `50M` | `20.0µs` | `70.19ms` | `71.98ms` | `70.89ms` |
...
| 🥈 | **Euler/Basel** ▲ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592634444062` | `1.91e-8` | `70.19ms` |
| 🥉 | **Leibniz** ■ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592633590251` | `2.00e-8` | `70.89ms` |
| 4th | **Wallis** ● | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592643066262` | `1.05e-8` | `71.98ms` |
