...
> 🕐 **Updated:** 2026-06-08 04:38 UTC &nbsp;|&nbsp; **Commit:** [`ee3b084`](https://github.com/punitmishra/pi-race/actions/runs/27116346090) &nbsp;|&nbsp; **Winner:** **Ramanujan** with `15` correct digits &nbsp;|&nbsp; **Tier:** `extreme`
...
|------------|--------|--------|--------|--------|
| `10` | `11.6µs` | `0.1µs` | `0.3µs` | `0.3µs` |
| `100` | `23.4µs` | `0.2µs` | `0.2µs` | `0.2µs` |
| `1K` | `20.3µs` | `1.5µs` | `1.5µs` | `1.5µs` |
| `10K` | `20.4µs` | `13.9µs` | `14.0µs` | `13.9µs` |
| `100K` | `20.0µs` | `139.0µs` | `140.0µs` | `139.0µs` |
| `1M` | `19.8µs` | `1.42ms` | `1.40ms` | `1.41ms` |
| `5M` | `19.8µs` | `7.16ms` | `7.01ms` | `7.01ms` |
| `10M` | `19.9µs` | `14.15ms` | `14.01ms` | `14.03ms` |
| `50M` | `19.8µs` | `70.91ms` | `70.77ms` | `70.51ms` |
...
| 🥈 | **Leibniz** ■ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592633590251` | `2.00e-8` | `70.51ms` |
| 🥉 | **Wallis** ● | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592643066262` | `1.05e-8` | `70.77ms` |
| 4th | **Euler/Basel** ▲ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592634444062` | `1.91e-8` | `70.91ms` |
