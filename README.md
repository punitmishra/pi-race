...
> 🕐 **Updated:** 2026-04-20 04:12 UTC &nbsp;|&nbsp; **Commit:** [`4748fdf`](https://github.com/punitmishra/pi-race/actions/runs/24648050376) &nbsp;|&nbsp; **Winner:** **Ramanujan** with `15` correct digits &nbsp;|&nbsp; **Tier:** `extreme`
...
|------------|--------|--------|--------|--------|
| `10` | `12.6µs` | `0.1µs` | `0.3µs` | `0.3µs` |
| `100` | `33.0µs` | `0.2µs` | `0.2µs` | `0.2µs` |
| `1K` | `30.4µs` | `2.3µs` | `1.7µs` | `1.6µs` |
| `10K` | `29.7µs` | `19.6µs` | `31.1µs` | `15.7µs` |
| `100K` | `31.9µs` | `191.6µs` | `160.3µs` | `179.2µs` |
| `1M` | `31.9µs` | `1.76ms` | `1.61ms` | `1.67ms` |
| `5M` | `30.7µs` | `8.72ms` | `8.27ms` | `8.12ms` |
| `10M` | `30.4µs` | `17.38ms` | `16.12ms` | `16.46ms` |
| `50M` | `30.3µs` | `86.54ms` | `80.68ms` | `83.47ms` |

### Accuracy Race @ `50M`

| Rank | Algorithm | Digits | Accuracy | Estimate | Error | Time |
|------|-----------|--------|----------|----------|-------|------|
| 🥇 | **Ramanujan** ◆ | `15` | `████████████████████ 100%` | `3.141592653589793` | `0.00e0` | `30.3µs` |
| 🥈 | **Wallis** ● | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592643066262` | `1.05e-8` | `80.68ms` |
| 🥉 | **Leibniz** ■ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592633590251` | `2.00e-8` | `83.47ms` |
| 4th | **Euler/Basel** ▲ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592634444062` | `1.91e-8` | `86.54ms` |
