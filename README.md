...
> 🕐 **Updated:** 2026-03-23 03:59 UTC &nbsp;|&nbsp; **Commit:** [`a855397`](https://github.com/punitmishra/pi-race/actions/runs/23420807895) &nbsp;|&nbsp; **Winner:** **Ramanujan** with `15` correct digits &nbsp;|&nbsp; **Tier:** `extreme`
...
|------------|--------|--------|--------|--------|
| `10` | `11.0µs` | `0.1µs` | `0.1µs` | `0.3µs` |
| `100` | `22.8µs` | `0.2µs` | `0.2µs` | `0.2µs` |
| `1K` | `20.3µs` | `1.4µs` | `1.5µs` | `1.7µs` |
| `10K` | `20.2µs` | `13.9µs` | `14.2µs` | `16.7µs` |
| `100K` | `19.9µs` | `138.9µs` | `140.2µs` | `167.6µs` |
| `1M` | `19.8µs` | `1.43ms` | `1.41ms` | `1.72ms` |
| `5M` | `19.8µs` | `7.28ms` | `7.01ms` | `8.42ms` |
| `10M` | `19.9µs` | `14.10ms` | `14.01ms` | `14.08ms` |
| `50M` | `19.8µs` | `70.06ms` | `71.65ms` | `70.69ms` |

### Accuracy Race @ `50M`

| Rank | Algorithm | Digits | Accuracy | Estimate | Error | Time |
|------|-----------|--------|----------|----------|-------|------|
| 🥇 | **Ramanujan** ◆ | `15` | `████████████████████ 100%` | `3.141592653589793` | `0.00e0` | `19.8µs` |
| 🥈 | **Euler/Basel** ▲ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592634444062` | `1.91e-8` | `70.06ms` |
| 🥉 | **Leibniz** ■ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592633590251` | `2.00e-8` | `70.69ms` |
| 4th | **Wallis** ● | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592643066262` | `1.05e-8` | `71.65ms` |
