...
> 🕐 **Updated:** 2026-08-03 06:29 UTC &nbsp;|&nbsp; **Commit:** [`15ab8dc`](https://github.com/punitmishra/pi-race/actions/runs/30790355361) &nbsp;|&nbsp; **Winner:** **Ramanujan** with `15` correct digits &nbsp;|&nbsp; **Tier:** `extreme`
...
|------------|--------|--------|--------|--------|
| `10` | `8.8µs` | `0.1µs` | `0.1µs` | `0.1µs` |
| `100` | `20.9µs` | `0.2µs` | `0.2µs` | `0.2µs` |
| `1K` | `20.4µs` | `1.4µs` | `1.5µs` | `1.5µs` |
| `10K` | `20.3µs` | `13.9µs` | `13.9µs` | `13.9µs` |
| `100K` | `20.0µs` | `165.0µs` | `139.0µs` | `139.2µs` |
| `1M` | `20.7µs` | `1.41ms` | `1.41ms` | `1.42ms` |
| `5M` | `19.9µs` | `7.05ms` | `7.01ms` | `7.03ms` |
| `10M` | `19.9µs` | `14.03ms` | `14.00ms` | `14.09ms` |
| `50M` | `19.9µs` | `70.20ms` | `71.12ms` | `70.54ms` |
...
| 🥈 | **Euler/Basel** ▲ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592634444062` | `1.91e-8` | `70.20ms` |
| 🥉 | **Leibniz** ■ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592633590251` | `2.00e-8` | `70.54ms` |
| 4th | **Wallis** ● | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592643066262` | `1.05e-8` | `71.12ms` |
