...
> 🕐 **Updated:** 2026-04-27 04:19 UTC &nbsp;|&nbsp; **Commit:** [`6fb5154`](https://github.com/punitmishra/pi-race/actions/runs/24976344636) &nbsp;|&nbsp; **Winner:** **Ramanujan** with `15` correct digits &nbsp;|&nbsp; **Tier:** `extreme`
...
|------------|--------|--------|--------|--------|
| `10` | `11.3µs` | `0.1µs` | `0.2µs` | `0.2µs` |
| `100` | `24.4µs` | `0.2µs` | `0.2µs` | `0.2µs` |
| `1K` | `21.4µs` | `1.4µs` | `1.3µs` | `1.2µs` |
| `10K` | `21.3µs` | `12.9µs` | `13.0µs` | `11.5µs` |
| `100K` | `21.1µs` | `129.3µs` | `129.6µs` | `114.6µs` |
| `1M` | `21.0µs` | `1.32ms` | `1.31ms` | `1.15ms` |
| `5M` | `21.0µs` | `6.64ms` | `6.51ms` | `5.75ms` |
| `10M` | `21.0µs` | `13.48ms` | `13.06ms` | `11.54ms` |
| `50M` | `21.0µs` | `66.83ms` | `65.10ms` | `57.54ms` |

### Accuracy Race @ `50M`

| Rank | Algorithm | Digits | Accuracy | Estimate | Error | Time |
|------|-----------|--------|----------|----------|-------|------|
| 🥇 | **Ramanujan** ◆ | `15` | `████████████████████ 100%` | `3.141592653589793` | `0.00e0` | `21.0µs` |
| 🥈 | **Leibniz** ■ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592633590251` | `2.00e-8` | `57.54ms` |
| 🥉 | **Wallis** ● | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592643066262` | `1.05e-8` | `65.10ms` |
| 4th | **Euler/Basel** ▲ | `7` | `█████████░░░░░░░░░░░ 46%` | `3.141592634444062` | `1.91e-8` | `66.83ms` |
